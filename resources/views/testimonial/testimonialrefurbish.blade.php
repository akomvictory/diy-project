		...
		*************************************-->
		...
		<main id="listar-main" class="listar-main listar-haslayout">
			...
			*************************************-->
			 ...
			 <form action="/resources/testimonial/{$post->id}/refurbish" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                               ...
                               <input type="file" accept=".jpg, .png, .jpeg, .gif" name="publisherPhoto" id="cover_image" class="inpt-control">
                                   ...
                                   <div class="col-md-12">
                                      ...
                                      <textarea name="postSectionOne"  id="com_desC" class="inpt-control"> </textarea>
