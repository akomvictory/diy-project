		...
		*************************************-->
		<main id="listar-main" class="listar-main listar-innerspeace listar-bglight listar-haslayout">
							...
							<div class="col-xs-12 col-sm-6 col-md-3 col-lg-2">
								<div class="listar-themepost listar-post">
									<figure class="listar-featuredimg">
										<a href="/resources/course/{{$post->courseSlug}}/pane"><img style="width: 19em; height: 13em" src="/storage/upload/blog/photos/{{$post->courseCoverPhoto}}" alt="image description"></a>
									...
									<div class="listar-postcontent">
										...
										<h2><a href="/resources/course/{{$post->courseSlug}}/pane">{{substr($post->courseTitle, 0, 20).'..'}}</a></h2>
            ...
            @if(count($datumTwo)>0)
                ...
                <li><a href="#">No Post Published yet</a></li>
