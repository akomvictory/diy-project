                                   		...
                                   		<div class="col-md-12">
                                   			...
                                   			<table class="table table-hover">
                                   				...
                                   				<tr>	  
                                   					...
                                   					<td class="info"> <strong> Post Slug </strong> <span class="fa fa-edit (alias)"></span> </td> 
                                   		  ...
                                   		  <td class="alert alert-success">  {{$post->id}} </td> 
                                   		   ...
                                   		   <td>  {{$post->courseSlug}} </td>
                                   		    ...
                                   		    <td>  
                                   		    	...
                                   		    	<a href="/resources/coursepanel/{{$post->id}}/refurbish" class="btn btn-default"> Update </a>  </td>

                                   		    	<td>

                                   		    <form action="/resources/coursepanel/{{$post->id}}/delete" method="POST">
