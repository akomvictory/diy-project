...
alert("Please make sure before publishing post that: Slug Photo is 54x54, post Cover Photo is 401x299, category Title is less than 12 characters, Slug is less tha 12 characters");
		...
		<header id="listar-dashboardheader" class="listar-dashboardheader listar-haslayout">
			<div class="cd-auto-hide-header listar-haslayout">
				<div class="container-fluid">
					<div class="row">
						<strong class="listar-logo"><a href=""><img src="images/logo.png" alt="company logo here"></a></strong>
				...
				<div id="listar-verticalscrollbar" class="listar-verticalscrollbar">
					<nav id="listar-navdashboard" class="listar-navdashboard">
						...
						<ul>
							...
							<li>
								<a href="/resources/coursepanel/publish">
									<i class="fa fa-tasks"></i>
									<span>Coursespanel publish</span>
								</a>
							</li>

							<li>
								<a href="/resources/coursepane/publish">
									<i class="fa fa-tasks"></i>
									<span>Coursepane publish</span>
								</a>
							</li>

							<li>
								<a href="/application/netcategory/publish">
									<i class="fa fa-tasks"></i>
									<span>NetCategory publish</span>
								</a>
							</li>
						...
						<ul>
							<li>
								<a href="/resources/blog/list">
									<i class="fa fa-tasks"></i>
									<span>Blog List</span>
								</a>
							</li>
							<li>
								<a href="/resources/coursepanel/list">
									<i class="fa fa-tasks"></i>
									<span>Coursepanel List</span>
								</a>
							</li>

								<li>
								<a href="/resources/coursepane/list">
									<i class="fa fa-tasks"></i>
									<span>Coursepane List</span>
								</a>
							</li>

							<li>
								<a href="/application/netcategory/list">
									<i class="fa fa-tasks"></i>
									<span>NetCategory list</span>
								</a>
							</li>
		...
		*************************************-->
		...
		<main id="listar-main" class="listar-main listar-haslayout">
			...
			*************************************-->
			 ...
			 <form action="/application/netcategory/publish" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="col-md-4">
                                            <div class="inpt-form-group"> 
                                               ...
                                               <div class="inpt-group"> 
                                                   ...
                                                   <input type="text"  name="slugTag"  id="bus_catGo" class="inpt-control" placeholder="Health">
                                            ...
                                            <div class="col-md-4">
                                            <div class="inpt-form-group"> 
                                             <label> category CoverPhoto</label>
                                                <div class="inpt-group">
                               <input type="file" accept=".jpg, .png, .jpeg, .gif" name="categoryCoverPhoto" id="cover_image" class="inpt-control">
                                           ...
                                           <div class="col-md-4">
                                            <div class="inpt-form-group"> 
                                             <label> category SlugPhoto *</label>
                                                <div class="inpt-group">
                               <input type="file" accept=".jpg, .png, .jpeg, .gif" name="categorySlugPhoto" id="cover_image" class="inpt-control">
                                   ...
                                   <div class="col-md-12">
                                      ...
                                      <textarea name="categoryTitle"  id="com_desC" class="inpt-control"> </textarea>
