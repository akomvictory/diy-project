							...
							@foreach($datumOne as $post)
									...
									<div class="listar-themepost listar-placespost">
										<figure class="listar-featuredimg"><a href="j/business/{{$post->businessName}}/detail"><img src="/storage/upload/dashboard/photos/{{$post->coverPhoto}}" alt="image description" class="mCS_img_loaded"></a></figure>
	...
	@foreach($datumTwo as $post)
		...
		<div class="listar-themepost listar-placespost">
										<figure class="listar-featuredimg"><a href="/business/{{$post->businessName}}/detail"><img src="/storage/upload/dashboard/photos/{{$post->coverPhoto}}" alt="image description" class="mCS_img_loaded"></a></figure>
										<div class="listar-postcontent">
											<h3><a href="/business/{{$post->businessName}}/detail">{!!substr($post->businessName, 0, 9).'..'!!}</a></h3>
											<div class="listar-description">
												<p>{{substr($post->BusinessInfo, 0, 40).'..'}}</p>
