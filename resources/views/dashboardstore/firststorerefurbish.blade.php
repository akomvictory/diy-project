      ...
      @section('contentone')
		...
		<main id="listar-main" class="listar-main listar-haslayout">
			...
			*************************************-->
			 ...
			 <form action="/application/store/{{$updateStore->id}}/refurbish" method="POST" enctype="multipart/form-data">
...
Turn your visitors into paying customers with exciting offers and services on your page.
        ...
        <div class="rms-form-wizard">
                                        ...
                                        <div class="col-md-4">
                                            <div class="inpt-form-group"> 
                                               ...
                                               <div class="inpt-group"> 
                                                   ...
                                                   <input type="text"  name="itemTitle"  id="bus_catGo" class="inpt-control" value="{{$updateStore->itemTitle}}">
                                           ...
                                           <div class="col-md-3">
                                            <div class="inpt-form-group"> 
                                               ...
                                               <div class="inpt-group"> 
                                                   ...
                                                   <input type="text" value="{{$updateStore->itemPrice}}"  name="itemPrice" id="bus_adD" class="inpt-control">
                                                   <div class="form-tooltip tooltip-edge">
                                                        <span class="tooltip-title">Why do you need this guide?</span>
                                            ...
                                            <div class="inpt-form-group"> 
                                             <label> Item image *</label>
                                                <div class="inpt-group">
                               <input type="file" accept=".jpg, .png, .jpeg, .gif" value="{{$updateStore->itemImage}}" name="itemImage" id="cover_image" class="inpt-control">
         ...
         <textarea name="itemDescription"  id="com_desC" class="inpt-control">{{$updateStore->itemDescription}}</textarea>
