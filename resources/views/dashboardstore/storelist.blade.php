           ...
           <!--Wizard Step Navigation Start-->
            ...
            <div class="rms-content-section">
                <div class="rms-content-box rms-current-section">
                        ...
                        <div class="products">
                            <img src="/storage/upload/store/photos/{{$item->itemImage}}" style="width: 20em; height: 10em" class="img-responsive" />
                            <h4 class="text-info"> @if(strlen($item->itemTitle)<9) 
                            	{{$item->itemTitle}} 

                            	@else

                            	{{substr($item->itemTitle, 0, 8).'..'}}
                            ...
                            <a href="/{{$item->businessName}}/store/{{$item->id}} " class="btn btn-info">Check Out<br/></a> 
