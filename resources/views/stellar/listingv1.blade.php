							...
							@foreach($datumOne as $post)
									...
									<div class="listar-themepost listar-placespost">
										<figure class="listar-featuredimg"><a href="javascript:void(0);"><img src="/storage/upload/dashboard/photos/{{$post->coverPhoto}}" alt="image description" class="mCS_img_loaded"></a></figure>
										<div class="listar-postcontent">
											<h3><a href="javascript:void(0);">{{substr($post->businessName, 0, 9).'..'}}</a></h3>
		...
		<div class="modal-dialog listar-modaldialog" role="document">
			<div class="modal-content listar-modalcontent">
				<div class="listar-themepost listar-placespost">
					...
					<div class="listar-postcontent">
						<h3><a href="javascript:void(0);">{{substr($post->businessName, 0, 9).'..'}}</a>
	...
	@elseif(count($datumFour)>0)

	@foreach($datumFour as $post)
