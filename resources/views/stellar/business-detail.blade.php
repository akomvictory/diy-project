...
@foreach($findBuisness as $business)
							...
							<div class="listar-postcontent">
								...
								<div class="listar-reviewcategory">
									...
									<ul class="listar-postinfotags">
										...
										<li><a href="#" class="like"><i class="fa fa-hand-o-right">
											
	{{ Auth::user()->like()->where('NetGuard',$business->id)->first() ? Auth::user()->like()->where('NetGuard',$business->id)->first()->like = 1 ? 'You like this page' : 'like' : 'like' }}

										</i><span>23</span></a></li>

										<li><a href="#" class="like"><i class="fa fa-hand-o-down">
											
{{ Auth::user()->like()->where('NetGuard',$business->id)->first() ? Auth::user()->like()->where('NetGuard',$business->id)->first()->like = 0 ? 'You Dislike this page' : 'Dislike' : 'Dislike' }}
								...
								<div class="tab-content listar-themetabcontent">
									...
									<div role="tabpanel" class="tab-pane" id="reviews">
										<ul id="listar-comments" class="listar-comments">
											...
											<!--<img src="images/img-02.jpg" alt="image description"> -->
														...
														<div class="listar-authorinfo">
															<h3>{!!substr($post->reviewerName, 0, 14).'..'!!}</h3>
										...
										<div class="listar-formreviewarea">
											<h3>Add Review</h3>
									<form class="listar-formtheme listar-formaddreview" method="POST" action="/business/review" enctype="multipart/form-data">
			 								 ...
			 								 @csrf
												<fieldset>
													<div class="row">
														...
														<input type="hidden" name="business_ref" value="{{$business->businessName}}">

														<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
															<label class="listar-fileuploadlabel" for="listar-photogallery">
																<i class="icon-upload3"></i>
																<span>Upload Images</span>
																<input id="listar-photogallery" class="listar-fileinput" type="file" name="reviewerPhoto">
															</label>
														</div>
														<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
															<div class="form-group">
																<input type="text" minlength="4" required name="reviewerName" class="form-control" placeholder="Your Name">
															</div>
														</div>
														<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
															<div class="form-group">
																<input type="text" required name="reviewerEmail" class="form-control" placeholder="Email Address">
															</div>
														</div>
													
														<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
															<div class="form-group">
																<label class="label label-danger">150 chars max</label>
																<textarea required maxlength="200" minlength="10" name="reviewerComment" class="form-control"></textarea>
															</div>
														</div>
														<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
															<button type="submit" name="submit"  class="listar-btn listar-btngreen">Add Review</button>
														</div>
													</div>
												</fieldset>
											</form>
