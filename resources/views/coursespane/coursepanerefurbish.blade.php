		...
		*************************************-->
		...
		<main id="listar-main" class="listar-main listar-haslayout">
			...
			*************************************-->
			 ...
			 <form action="/resources/coursepane/{{$update->id}}/refurbish" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="col-md-4">
                                            <div class="inpt-form-group"> 
                                               ...
                                               <div class="inpt-group"> 
                                                   ...
                                                   <input type="text" value="{{$update->publisherName}}" name="publisherName"  id="bus_catGo" class="inpt-control" placeholder="Victory Akom">
                                            ...
                                            <div class="inpt-form-group"> 
                                             <label> Publisher Photo*</label>
                                                <div class="inpt-group">
                               <input type="file" value="{{$update->publisherPhoto}}" accept=".jpg, .png, .jpeg, .gif" name="publisherPhoto" id="cover_image" class="inpt-control">
                                      ...
                                      <div class="col-md-12">
                                            <div class="inpt-form-group"> 
                                               ...
                                               <div class="inpt-group"> 
                                                   ...
                                                   <input type="text" value="{{$update->courseTitle}}"  name="postTitle" id="bus_adD" class="inpt-control" placeholder="How To Win Client">
                                                   <div class="form-tooltip tooltip-edge">
                                                        <span class="tooltip-title">Why do you need this guide?</span>
                                   ...
                                   <div class="col-md-12">
                                      ...
                                      <textarea name="postSectionOne"  id="article-ckeditor" class="inpt-control"> {{$update->courseSectionOne}}</textarea>
                                   ...
                                   <div class="col-md-12">
                                            ...
                                            <div class="inpt-group">
                                                <span class="inpt-group-addon"><i class="fa fa-pencil" aria-hidden="true"></i></span> 
                                      <textarea name="postSectionTwo"  id="com_desC" class="inpt-control"> {{$update->courseSectionTwo}}</textarea>
                                                    <div class="form-tooltip">
                                                       <span class="tooltip-title">Why do you need this guide?</span>
                                   ...
                                   <div class="col-md-12">
                                            ...
                                            <div class="inpt-group">
                                                <span class="inpt-group-addon"><i class="fa fa-pencil" aria-hidden="true"></i></span> 
                                      <textarea name="postSectionThree"  id="com_desC" class="inpt-control">{{$update->courseSectionThree}} </textarea>
                                                    <div class="form-tooltip">
                                                       <span class="tooltip-title">Why do you need this guide?</span>
                                   ...
                                   <div class="col-md-12">
                                            ...
                                            <div class="inpt-group">
                                                <span class="inpt-group-addon"><i class="fa fa-pencil" aria-hidden="true"></i></span> 
                                      <textarea name="postSectionFour"  id="com_desC" class="inpt-control"> {{$update->courseSectionFour}} </textarea>
                                                    <div class="form-tooltip">
                                                       <span class="tooltip-title">Why do you need this guide?</span>
                                   ...
                                   <div class="col-md-12">
                                            ...
                                            <div class="inpt-group">
                                                <span class="inpt-group-addon"><i class="fa fa-pencil" aria-hidden="true"></i></span> 
                                      <textarea name="postSectionFive"  id="com_desC" class="inpt-control">{{$update->courseSectionFive}} </textarea>
                                                    <div class="form-tooltip">
                                                       <span class="tooltip-title">Why do you need this guide?</span>
                                         ...
                                         <div class="col-md-3">
                                            <div class="inpt-form-group"> 
                                             <label> Course Cover Photo</label>
                                                <div class="inpt-group">
                               <input type="file" value="{{$update->courseCoverPhoto}}" accept=".jpg, .png, .jpeg, .gif" name="postCoverPhoto" id="cover_image" class="inpt-control">
...
<div class="col-md-3">
                                            <div class="inpt-form-group"> 
                                             <label> Course Photo 1*</label>
                                                <div class="inpt-group">
                               <input type="file" value="{{$update->coursePhotoOne}}" accept=".jpg, .png, .jpeg, .gif" name="postPhotoOne" id="cover_image" class="inpt-control">
                                         ...
                                         <div class="col-md-3">
                                            <div class="inpt-form-group"> 
                                             <label> Course Photo 2*</label>
                                                <div class="inpt-group">
                               <input type="file" value="{{$update->coursePhotoTwo}}" accept=".jpg, .png, .jpeg, .gif" name="postPhotoTwo" id="cover_image" class="inpt-control">
                                          ...
                                          <div class="col-md-3">
                                            <div class="inpt-form-group"> 
                                             <label> Course Photo 3*</label>
                                                <div class="inpt-group">
                               <input type="file" value="{{$update->coursePhotoThree}}" accept=".jpg, .png, .jpeg, .gif" name="postPhotoThree" id="cover_image" class="inpt-control">
                                 ...
                                 <div class="col-md-3">
                                            <div class="inpt-form-group"> 
                                             <label> Course Photo 4*</label>
                                                <div class="inpt-group">
                               <input type="file" value="{{$update->coursePhotoFour}}" accept=".jpg, .png, .jpeg, .gif" name="postPhotoFour" id="cover_image" class="inpt-control">
                                            ...
                                            <div class="inpt-form-group"> 
                                             <label> Course Photo 5*</label>
                                                <div class="inpt-group">
                               <input type="file" value="{{$update->coursePhotoFive}}" accept=".jpg, .png, .jpeg, .gif" name="postPhotoFive" id="cover_image" class="inpt-control">
