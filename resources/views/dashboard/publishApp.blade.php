      ...
      @section('contentone')
		...
		<main id="listar-main" class="listar-main listar-haslayout">
			...
			*************************************-->
			 ...
			 <form action="/application/dashboard/publish" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="col-md-8">
                                   ...
                                   <div class="col-md-12">
                                            ...
                                            <div class="inpt-group">
                                                ...
                                                <input type="text" name="businessName"  id="username" class="inpt-control" placeholder="e.g NetGuba Inc."> 
                                        ...
                                        <div class="col-md-6">
                                            <div class="inpt-form-group"> 
                                               ...
                                               <div class="inpt-group"> 
                                                   ...
                                                   <input type="text" name="businessCategoryOne"  id="bus_catGo" class="inpt-control" placeholder="Baby Shop">
                                           ...
                                           <div class="col-md-6">
                                            <div class="inpt-form-group"> 
                                               ...
                                               <div class="inpt-group"> 
                                                   ...
                                                   <input type="text" name="businessAddress" id="bus_adD" class="inpt-control" placeholder="No1 zx Avenue, Owerri">
                                                   <div class="form-tooltip tooltip-edge">
                                                        <span class="tooltip-title">Why do you need this guide?</span>
                                   ...
                                   <div class="col-md-12">
                                            ...
                                            <div class="inpt-group">
                                                <span class="inpt-group-addon"><i class="fa fa-building-o" aria-hidden="true"></i></span> 
                                      <textarea name="BusinessInfo"  id="article-ckeditor" class="inpt-control"> </textarea>
                                                    <div class="form-tooltip">
                              ...
                              <div class="col-md-6">
                                            <div class="inpt-form-group"> 
                                               ...
                                               <div class="inpt-group"> 
                                                   ...
                                                   <input type="text"  name="cityOfOperation" id="website" class="inpt-control" placeholder="Abuja">
                                                   <div class="form-tooltip tooltip-edge">
                                                        <span class="tooltip-title">Why do you need this info?</span>
                                                       <p class="tooptip-content">
                                  ...
                                  <div class="col-md-8">
                                            <div class="inpt-form-group"> 
                                               ...
                                               <div class="inpt-group"> 
                                                   ...
                                                   <input type="text" name="businessWebUrl" id="website" class="inpt-control"   placeholder="Example: http://www.yourwebsite.com">
                                                   <div class="form-tooltip tooltip-edge">
                                                        <span class="tooltip-title">Why do you need this info?</span>
                                                       <p class="tooptip-content">
                                            ...
                                            <div class="inpt-form-group"> 
                                               ...
                                               <div class="inpt-group"> 
                                                   ...
                                                   <input type="text" name="businessPhoneNumber"  id="phone_number" class="inpt-control" placeholder="Please Enter your phone Number">
                                                   <div class="form-tooltip tooltip-edge">
                                                        <span class="tooltip-title">Why do you need this info?</span>
                                        ...
                                        <div class="col-md-12">
                                            <div class="inpt-form-group"> 
                                               ...
                                               <div class="inpt-group"> 
                                                   ...
                                                   <input type="text" name="businessEmailUrl"   id="email" class="inpt-control" placeholder="Ex NetGuba@gmail.com">
                                                   <div class="form-tooltip tooltip-edge">
                                                        <span class="tooltip-title">Why do you need this info?</span>
                             ...
                             <div class="row">
                                    ...
                                    <div class="col-md-4">
                                           <div class="inpt-form-group"> 
                                               ...
                                               <div class="inpt-group">
                                                   ...
                                                   <input type="text" name="gubaHandle" id="guba_handle" class="inpt-control" placeholder="Ex emylpizza">
                                                   <div class="form-tooltip">
                                                       <span class="tooltip-title">Why do you need this info?</span>
                               ...
                               <div class="col-md-4">
                                           <div class="inpt-form-group"> 
                                               ...
                                               <div class="inpt-group">
                                               		 <span class="inpt-group-addon"><i class="fa fa-search-plus" aria-hidden="true"></i></span>
                                                   <input type="text" name="keywordOne" maxlength="45" minlength="3" id="keyword" class="inpt-control" placeholder="Fast Food">
                                                   <div class="form-tooltip">
                                                       <span class="tooltip-title">Why do you need this info?</span>
                                          ...
                                          <div class="col-md-4">
                                           <div class="inpt-form-group"> 
                                               ...
                                               <div class="inpt-group">
                                               		 <span class="inpt-group-addon"><i class="fa fa-search-plus" aria-hidden="true"></i></span>
                                                   <input type="text" name="keywordtwo" id="keyword" class="inpt-control" placeholder="Baby Wears">
                                                   <div class="form-tooltip">
                                                       <span class="tooltip-title">Why do you need this info?</span>
                                                       <p class="tooptip-content">This field only accept 45char maximum and 3char minimum </p>
                                                        <span class="tooltip-info">Your information is Safe here &amp; never shared.</span>
                                  ...
                                  <div class="col-md-4">
                                           <div class="inpt-form-group"> 
                                               ...
                                               <div class="inpt-group">
                                               		 <span class="inpt-group-addon"><i class="fa fa-search-plus" aria-hidden="true"></i></span>
                                                   <input type="text" name="keywordThree" maxlength="45" minlength="3" id="keyword" class="inpt-control" placeholder="Italian Shoe">
                                                   <div class="form-tooltip">
                                                       <span class="tooltip-title">Why do you need this info?</span>
                                                       <p class="tooptip-content">This field only accept 45char maximum and 3char minimum </p>
                                                        <span class="tooltip-info">Your information is Safe here &amp; never shared.</span>
                               ...
                               <div class="col-md-4">
                                           <div class="inpt-form-group"> 
                                               ...
                                               <div class="inpt-group">
                                               		 <span class="inpt-group-addon"><i class="fa fa-search-plus" aria-hidden="true"></i></span>
                                                   <input type="text" name="keywordFour" maxlength="45" minlength="3" id="keyword" class="inpt-control" placeholder="Men Suits">
                                                   <div class="form-tooltip">
                                                       <span class="tooltip-title">Why do you need this info?</span>
                                                       <p class="tooptip-content">This field only accept 45char maximum and 3char minimum </p>
                                                        <span class="tooltip-info">Your information is Safe here &amp; never shared.</span>
                                           ...
                                           <div class="inpt-form-group"> 
                                               ...
                                               <div class="inpt-group">
                                               		 <span class="inpt-group-addon"><i class="fa fa-search-plus" aria-hidden="true"></i></span>
                                                   <input type="text" name="keywordFive" maxlength="45" minlength="3" id="keyword" class="inpt-control" placeholder="Groceries">
                                                   <div class="form-tooltip">
                                                       <span class="tooltip-title">Why do you need this info?</span>
                                                       <p class="tooptip-content">This field only accept 45char maximum and 3char minimum </p>
                                                        <span class="tooltip-info">Your information is Safe here &amp; never shared.</span>
                                  ...
                                  <div class="col-md-4">
                                           <div class="inpt-form-group"> 
                                               ...
                                               <div class="inpt-group">
                                               		 <span class="inpt-group-addon"><i class="fa fa-search-plus" aria-hidden="true"></i></span>
                                                   <input type="text" name="keywordSix" maxlength="45" minlength="3" id="keyword" class="inpt-control" placeholder="Electronics">
                                                   <div class="form-tooltip">
                                                       <span class="tooltip-title">Why do you need this info?</span>
                                                       <p class="tooptip-content">This field only accept 45char maximum and 3char minimum </p>
                                                        <span class="tooltip-info">Your information is Safe here &amp; never shared.</span>
                               ...
                               <div class="col-md-4">
                                           <div class="inpt-form-group"> 
                                               ...
                                               <div class="inpt-group">
                                               		 <span class="inpt-group-addon"><i class="fa fa-search-plus" aria-hidden="true"></i></span>
                                                   <input type="text" name="keywordSeven" maxlength="45" minlength="3" id="keyword" class="inpt-control" placeholder="Gadget">
                                                   <div class="form-tooltip">
                                                       <span class="tooltip-title">Why do you need this info?</span>
                                                       <p class="tooptip-content">This field only accept 45char maximum and 3char minimum </p>
                                                        <span class="tooltip-info">Your information is Safe here &amp; never shared.</span>
                                           ...
                                           <div class="inpt-form-group"> 
                                               ...
                                               <div class="inpt-group">
                                               		 <span class="inpt-group-addon"><i class="fa fa-search-plus" aria-hidden="true"></i></span>
                                                   <input type="text" name="keywordEight" maxlength="45" minlength="3" id="keyword" class="inpt-control" placeholder="Stationery">
                                                   <div class="form-tooltip">
                                                       <span class="tooltip-title">Why do you need this info?</span>
                                                       <p class="tooptip-content">This field only accept 45char maximum and 3char minimum </p>
                                                        <span class="tooltip-info">Your information is Safe here &amp; never shared.</span>
                                          ...
                                          <div class="col-md-4">
                                            <div class="inpt-form-group"> 
                                             <span class="fa fa-facebook"> facebook</span>
                                                <div class="inpt-group">
                                                    <input type="text" name="facebookUrl"  id="facebook" class="inpt-control" placeholder="https://www.facebook.com/">
                                                    <div class="form-tooltip">
                                                        <span class="tooltip-title">Why do you need this info?</span>
                                            ...
                                            <div class="inpt-form-group"> 
                                             <span class="fa fa-twitter"> twitter</span>
                                                <div class="inpt-group">
                                                    <input type="text" name="twitterUrl"  id="twitter" class="inpt-control" placeholder="https://www.twitter.com/">
                                                    <div class="form-tooltip">
                                                        <span class="tooltip-title">Why do you need this info?</span>
                                            ...
                                            <div class="inpt-form-group"> 
                                             <span class="fa fa-instagram"> instagram</span>
                                                <div class="inpt-group">
                                                    <input type="text"  name="instagramUrl" id="cvc" class="inpt-control" placeholder="https://www.instagram.com/">
                                                    <div class="form-tooltip">
                                                        <span class="tooltip-title">Why do you need this info?</span>
                                          ...
                                          <div class="row"> 
                                            ...
                                            <div class="inpt-form-group"> 
                                             <span class="fa fa-calendar"> Monday</span>
                                                <div class="inpt-group">
                                                    <input type="text" name="monOperationTime" id="mon_biz_hour" class="inpt-control" placeholder="">
                                                    <div class="form-tooltip">
                                                        <span class="tooltip-title">Why do you need this info?</span>
                                            ...
                                            <div class="inpt-form-group"> 
                                             <span class="fa fa-calendar"> Tuesday</span>
                                                <div class="inpt-group">
                                                    <input type="text" name="tueOPerationTime" id="tue_biz_hour" class="inpt-control" placeholder="">
                                                    <div class="form-tooltip">
                                                        <span class="tooltip-title">Why do you need this info?</span>
                                            ...
                                            <div class="inpt-form-group"> 
                                             <span class="fa fa-calendar"> Wednesday</span>
                                                <div class="inpt-group">
                                                    <input type="text" name="wedOperationTime" id="wed_biz_hour" class="inpt-control" maxlength="35" placeholder="">
                                                    <div class="form-tooltip">
                                                        <span class="tooltip-title">Why do you need this info?</span>
                                            ...
                                            <div class="inpt-form-group"> 
                                             <span class="fa fa-calendar"> Thursday</span>
                                                <div class="inpt-group">
                                                    <input type="text" name="thursOperationTime" id="thur_biz_hour" class="inpt-control" maxlength="35" placeholder="">
                                                    <div class="form-tooltip">
                                                        <span class="tooltip-title">Why do you need this info?</span>
                                ...
                                <div class="row">
                                            ...
                                            <div class="inpt-form-group"> 
                                             <span class="fa fa-calendar"> Friday</span>
                                                <div class="inpt-group">
                                                    <input type="text" name="friOperationTime" maxlength="35" id="fri_biz_hour" class="inpt-control" placeholder="">
                                                    <div class="form-tooltip">
                                                        <span class="tooltip-title">Why do you need this info?</span>
                                            ...
                                            <div class="inpt-form-group"> 
                                             <span class="fa fa-calendar"> Saturday</span>
                                                <div class="inpt-group">
                                                    <input type="text" name="satOperationTime" maxlength="35" id="sat_biz_hour" class="inpt-control" placeholder="">
                                                    <div class="form-tooltip">
                                                        <span class="tooltip-title">Why do you need this info?</span>
                                            ...
                                            <div class="inpt-form-group"> 
                                             <span class="fa fa-calendar"> Sunday</span>
                                                <div class="inpt-group">
                                                    <input type="text" name="sunOperationTime" id="sun_biz_hour" class="inpt-control" maxlength="35" placeholder="">
                                                    <div class="form-tooltip">
                                ...
                                <div class="row">
                                            ...
                                            <div class="inpt-form-group"> 
                                             <label> Cover Image</label>
                                                <div class="inpt-group">
                               <input type="file" accept=".jpg, .png, .jpeg, .gif" name="coverPhoto" id="cover_image" class="inpt-control">
                                          ...
                                          <div class="col-md-4">
                                            <div class="inpt-form-group"> 
                                             <label> Photo One</label>
                                                <div class="inpt-group">
                               <input type="file" accept=".mp4, .jpg, .png, .jpeg, .gif" name="PhotoOne" class="inpt-control">
                                         ...
                                         <div class="col-md-4">
                                            <div class="inpt-form-group"> 
                                             <label> Photo Two</label>
                                                <div class="inpt-group">
                               <input type="file" accept=".jpg, .png, .jpeg, .gif" name="PhotoTwo" class="inpt-control">
			   ...
			   <div class="row">
			                                            ...
			                                            <div class="inpt-form-group"> 
			                                             <label> Photo Three</label>
			                                                <div class="inpt-group">
			                               <input type="file" accept=".jpg, .png, .jpeg, .gif" name="PhotoThree" id="cover_image" class="inpt-control">
			                                          ...
			                                          <div class="col-md-4">
			                                            <div class="inpt-form-group"> 
			                                             <label> Photo Four</label>
			                                                <div class="inpt-group">
			                               <input type="file" accept=".jpg, .png, .jpeg, .gif" name="PhotoFour"  class="inpt-control">
			                                         ...
			                                         <div class="col-md-4">
			                                            <div class="inpt-form-group"> 
			                                             <label> Photo Five</label>
			                                                <div class="inpt-group">
			                               <input type="file" accept=".jpg, .png, .jpeg, .gif" name="PhotoFive" class="inpt-control">
                                            ...
                                            <div class="inpt-form-group"> 
                                             <label> Photo Six</label>
                                                <div class="inpt-group">
                               <input type="file" accept=".jpg, .png, .jpeg, .gif" name="PhotoSix" id="cover_image" class="inpt-control">
                                          ...
                                          <div class="col-md-4">
                                            <div class="inpt-form-group"> 
                                             <label> Photo Seven</label>
                                                <div class="inpt-group">
                               <input type="file" accept=".jpg, .png, .jpeg, .gif" name="PhotoSeven" id="cover_image" class="inpt-control">
                                         ...
                                         <div class="col-md-4">
                                            <div class="inpt-form-group"> 
                                             <label> Photo Eight</label>
                                                <div class="inpt-group">
                               <input type="file" accept=".jpg, .png, .jpeg, .gif" name="PhotoEight" id="cover_image" class="inpt-control">
                                  ...
                                  <div class="row">
                                            ...
                                            <div class="inpt-form-group"> 
                                             <label> Photo Nine</label>
                                                <div class="inpt-group">
                               <input type="file" accept=".jpg, .png, .jpeg, .gif" name="PhotoNine" id="cover_image" class="inpt-control">
