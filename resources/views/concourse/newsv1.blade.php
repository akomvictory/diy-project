			...
			<div class="container-fluid">
				<div class="row">
					<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
						<strong class="listar-logo"><a href="index.html"><img src="/images/logod.png" alt="company logo here"></a></strong>
							...
							<div id="listar-navigation" class="collapse navbar-collapse listar-navigation">
								<ul>
									...
									<li class="menu-item-has-children">
										...
										<ul class="sub-menu">
											<li><a href="listingv1.html">All Listings</a></li>
											<li class="menu-item-has-children">
												<a href="javascript:void(0);">Food</a>
												<ul class="sub-menu">
													<li><a href="listingv2.html">Cafe</a></li>
													<li><a href="listingvlist.html">Restaurant</a></li>
												</ul>
											</li>
											<li class="menu-item-has-children">
												...
												<ul class="sub-menu">
													<li><a href="listingv2.html">Cafe</a></li>
													<li><a href="listingvlist.html">Pizza Place</a></li>
												</ul>
											</li>
											<li class="menu-item-has-children">
												<a href="javascript:void(0);">Educational</a>
												<ul class="sub-menu">
													<li><a href="listingvlist.html">Cafe</a></li>
												</ul>
											</li>
											<li class="menu-item-has-children">
											...
											<li class="menu-item-has-children">
												<a href="javascript:void(0);">List Detail Pages</a>
												<ul class="sub-menu">
													<li><a href="detailv1.html">Detail V One</a></li>
													<li><a href="detailv2.html">Detail V Two</a></li>
												</ul>
											</li>
										</ul>
									</li>
									...
									<li class="menu-item-has-children">
										...
										<ul class="sub-menu">
											<li><a href="newsv1.html">News V One</a></li>
											<li><a href="newsv2.html">News V Two</a></li>
									...
									<li class="menu-item-has-children">
										...
										<ul class="sub-menu">
											...
											<li><a href="dashboardaddlisting.html">Dashboard Add Listing</a></li>
											<li><a href="dashboardlisting.html">Dashboard Listing</a></li>
											<li><a href="dashboardmyprofile.html">Dashboard My Profile</a></li>
											<li><a href="dashboardreviews.html">Dashboard Reviews</a></li>
											<li><a href="dashboardwishlist.html">Dashboard Wishlist</a></li>
										</ul>
									</li>
								</ul>
							</div>
							...
							<div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
								<div class="listar-themepost listar-post">
									<figure class="listar-featuredimg">
										<a href="javascript:void(0);"><img src="/images/blog/img-13.jpg" alt="image description"></a>
										<a class="listar-postcategory" href="javascript:void(0);">Fitness</a>
									</figure>
									<div class="listar-postcontent">
										<figure class="listar-authorimg"><img src="/images/author/img-01.jpg" height="54" width="54" alt="image description"></figure>
										<h2><a href="javascript:void(0);">Electronics</a></h2>
							...
							<div class="listar-upperbox">
								...
								<nav class="listar-navfooter">
									<ul>
										...
										<li><a href="/page/comingsoon">About</a></li>
										<li><a href="/page/comingsoon">Services</a></li>
