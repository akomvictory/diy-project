						...
						<nav id="listar-nav" class="listar-nav">
							...
							<div id="listar-navigation" class="collapse navbar-collapse listar-navigation">
								<ul>
										...
										<li class="current-menu-item"><a href="/page/comingsoon">About</a></li>
									<li class="current-menu-item"><a href="/page/comingsoon">Services</a></li>
			...
			<div id="listar-twocolumns" class="listar-twocolumns">
				<div class="listar-themepost listar-post listar-detail listar-postdetail">
					<figure class="listar-featuredimg">
						<img src="/images/blog/5.jpg"  alt="image description">
						<figcaption>
							<div class="container">
								<div class="row">
									<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
										<div class="listar-postcontent">
											<div class="listar-postauthordpname">
												<span class="listar-postauthordp"><a href="javascript:void(0);"><img src="images/author/photo_14.png" alt="image description"></a></span>
												<span class="listar-postauhorname"><a href="javascript:void(0);">Victory Akom</a></span>
											</div>
											...
											<h1>A Lot to catch you up with soon</h1>
										</div>
									</div>
								</div>
							</div>
							...
							<div class="col-xs-12 col-sm-12 col-md-push-1 col-md-10 col-lg-push-1 col-lg-10">
								<div id="listar-detailcontent" class="listar-detailcontent">
									<div class="listar-description">
										<p>We are working currently to provide resourceful and meaningful content to our client, our aim is to provide client and general user with the best they seek for on our site. This page will be fully available in just a short while.</p>
