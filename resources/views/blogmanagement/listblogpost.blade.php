                                   	...
                                   	<div class="row">
                                   		...
                                   		<div class="col-md-12">
                                   		  ...
                                   		  <td class="alert alert-success">  {{$post->id}} </td> 
                                   		   ...
                                   		   <td>    {!!substr($post->postTitle, 0, 11).'..'!!}</td>
                                   		    ...
                                   		    <td>  
                                   		    	...
                                   		    	<a href="/resources/blog/{{$post->id}}/refurbish" class="btn btn-default"> Update </a>  </td>

                                   		    	<td>

                                   		    <form action="/resources/blog/{{$post->id}}/delete" method="POST">
