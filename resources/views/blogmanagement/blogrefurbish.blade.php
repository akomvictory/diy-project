		...
		<main id="listar-main" class="listar-main listar-haslayout">
			...
			*************************************-->
			 ...
			 <form action="/resources/blog/{{$refurbishblogpost->id}}/refurbish" method="POST" enctype="multipart/form-data">
                ...
                <div class="rms-content-box rms-current-section">
                                        ...
                                        <div class="col-md-4">
                                            <div class="inpt-form-group"> 
                                               ...
                                               <div class="inpt-group"> 
                                                   ...
                                                   <input type="text" value="{{$refurbishblogpost->publisherName}}"  name="publisherName"  id="bus_catGo" class="inpt-control" placeholder="Victory Akom">
                                            ...
                                            <div class="inpt-form-group"> 
                                             <label> Publisher Photo*</label>
                                                <div class="inpt-group">
                               <input type="file" value="{{$refurbishblogpost->publisherPhoto}}" accept=".jpg, .png, .jpeg, .gif" name="publisherPhoto" id="cover_image" class="inpt-control">
                                      ...
                                      <div class="col-md-12">
                                            <div class="inpt-form-group"> 
                                               ...
                                               <div class="inpt-group"> 
                                                   ...
                                                   <input type="text" value="{{$refurbishblogpost->postTitle}}"  name="postTitle" id="bus_adD" class="inpt-control" placeholder="How To Win Client">
                                                   <div class="form-tooltip tooltip-edge">
                                                        <span class="tooltip-title">Why do you need this guide?</span>
                                   ...
                                   <div class="col-md-12">
                                            <div class="inpt-form-group"> 
                                                <label>Post Section One</label>
                                            <div class="inpt-group">
                                                <span class="inpt-group-addon"><i class="fa fa-pencil" aria-hidden="true"></i></span> 
                                      <textarea name="postSectionOne"  id="article-ckeditor" class="inpt-control">

                                      	{{$refurbishblogpost->postSectionOne}}
                                   ...
                                   <div class="col-md-12">
                                            <div class="inpt-form-group"> 
                                                <label>Post Section Two</label>
                                            <div class="inpt-group">
                                                <span class="inpt-group-addon"><i class="fa fa-pencil" aria-hidden="true"></i></span> 
                                      <textarea name="postSectionTwo"  id="com_desC" class="inpt-control"> 
                                      	{{$refurbishblogpost->postSectionTwo}}
                                      </textarea>
                                                    <div class="form-tooltip">
                                                       <span class="tooltip-title">Why do you need this guide?</span>
                                   ...
                                   <div class="col-md-12">
                                            <div class="inpt-form-group"> 
                                                <label>Post Section Three</label>
                                            <div class="inpt-group">
                                                <span class="inpt-group-addon"><i class="fa fa-pencil" aria-hidden="true"></i></span> 
                                      <textarea name="postSectionThree"  id="com_desC" class="inpt-control">
                                      		{{$refurbishblogpost->postSectionThree}}
                                       </textarea>
                                                    <div class="form-tooltip">
                                                       <span class="tooltip-title">Why do you need this guide?</span>
                                   ...
                                   <div class="col-md-12">
                                            <div class="inpt-form-group"> 
                                                <label>Post Section Four</label>
                                            <div class="inpt-group">
                                                <span class="inpt-group-addon"><i class="fa fa-pencil" aria-hidden="true"></i></span> 
                                      <textarea name="postSectionFour"  id="com_desC" class="inpt-control">
                                      		{{$refurbishblogpost->postSectionFour}}
                                       </textarea>
                                                    <div class="form-tooltip">
                                                       <span class="tooltip-title">Why do you need this guide?</span>
                                   ...
                                   <div class="col-md-12">
                                            <div class="inpt-form-group"> 
                                                <label>Post Section Five</label>
                                            <div class="inpt-group">
                                                <span class="inpt-group-addon"><i class="fa fa-pencil" aria-hidden="true"></i></span> 
                                      <textarea name="postSectionFive"  id="com_desC" class="inpt-control">{{$refurbishblogpost->postSectionFive}}
                                      </textarea>
                                                    <div class="form-tooltip">
                                                       <span class="tooltip-title">Why do you need this guide?</span>
                        ...
                        <br/>
                                           <div class="row">
                                            <div class="col-md-4">
                                            <div class="inpt-form-group"> 
                                               <label for="state">Post Slug*</label>
                  ...
                  <option>Gospel</option>
                     ...
                     <option>Tourism</option>
                       ...
                       <option>Lifestyle</option>
                        <option>Uncategorised</option>
                                           ...
                                           <div class="col-md-4">
                                            <div class="inpt-form-group"> 
                                               <label for="state">Post Accessibility*</label>
                                                <div class="inpt-group dropdown-select-icon"> 
                    ...
                    <option>Homestead</option>
                                             ...
                                             <div class="col-md-4">
                                            <div class="inpt-form-group"> 
                                               <label for="state">Post Flag*</label>
                                                <div class="inpt-group dropdown-select-icon"> 
                    ...
                    <option>Featured</option>
                                         ...
                                         <div class="col-md-3">
                                            <div class="inpt-form-group"> 
                                             <label> Post Cover Photo</label>
                                                <div class="inpt-group">
                               <input type="file" value="{{$refurbishblogpost->postCoverPhoto}}" accept=".jpg, .png, .jpeg, .gif" name="postCoverPhoto" id="cover_image" class="inpt-control">
...
<div class="col-md-3">
                                            <div class="inpt-form-group"> 
                                             <label> Post Photo 1*</label>
                                                <div class="inpt-group">
                               <input type="file" value="{{$refurbishblogpost->postPhotoOne}}" accept=".jpg, .png, .jpeg, .gif" name="postPhotoOne" id="cover_image" class="inpt-control">
                                         ...
                                         <div class="col-md-3">
                                            <div class="inpt-form-group"> 
                                             <label> Post Photo 2*</label>
                                                <div class="inpt-group">
                               <input type="file" value="{{$refurbishblogpost->postPhotoTwo}}" accept=".jpg, .png, .jpeg, .gif" name="postPhotoTwo" id="cover_image" class="inpt-control">
                                          ...
                                          <div class="col-md-3">
                                            <div class="inpt-form-group"> 
                                             <label> Post Photo 3*</label>
                                                <div class="inpt-group">
                               <input type="file" value="{{$refurbishblogpost->postPhotoThree}}" accept=".jpg, .png, .jpeg, .gif" name="postPhotoThree" id="cover_image" class="inpt-control">
                                 ...
                                 <div class="col-md-3">
                                            <div class="inpt-form-group"> 
                                             <label> Post Photo 4*</label>
                                                <div class="inpt-group">
                               <input type="file" value="{{$refurbishblogpost->postPhotoFive}}" accept=".jpg, .png, .jpeg, .gif" name="postPhotoFour" id="cover_image" class="inpt-control">
  											...
  											<div class="col-md-3">
                                            <div class="inpt-form-group"> 
                                             <label> Post Photo 5*</label>
                                                <div class="inpt-group">
                               <input type="file" value="{{$refurbishblogpost->postPhotoFive}}" accept=".jpg, .png, .jpeg, .gif" name="postPhotoFive" id="cover_image" class="inpt-control">
